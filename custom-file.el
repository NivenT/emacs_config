...
\"###########.######\" };")))
 ...
 '(package-selected-packages
   (quote
    (clang-format+ clang-format ccls company-lsp helm-lsp lsp-ui ron-mode prettier-js js-format xref-js2 js2-refactor js2-mode flycheck-inline flycheck-rust company racer cargo alect-dark rustic rust-mode slime)))
